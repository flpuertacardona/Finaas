...
namespace Finaas.Web.Controllers
{
    public class EscuelasController : Controller
    {
        ...
        public EscuelasController(InvestigacionContext context)
        {
            _context = context;
        }
        ...
        {
            var investigacionContext = _context.Escuelas.Include(e => e.Decano);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Conocimiento,FechaApertura,ProfesorId")] Escuela escuela)
        {
            ...
            ViewData["ProfesorId"] = new SelectList(_context.Profesores, "Id", "Id", escuela.ProfesorId);
            return View(escuela);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Conocimiento,FechaApertura,ProfesorId")] Escuela escuela)
        {
            if (id != escuela.Id)
            {
                return NotFound();
